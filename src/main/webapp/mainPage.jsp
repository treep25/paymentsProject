...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand " href="mainPage.jsp" ><fmt:message key="payments"/> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="24" height="24" fill="currentColor" >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item disabled" tabindex="-1" aria-disabled="true"><a class="nav-link active" aria-current="page"><fmt:message key="home"/></a></li>
                <li class="nav-item"><a class="nav-link" href="aboutUs.jsp"><fmt:message key="about.us"/></a></li>
            </ul>
            <a class="btn btn-primary m-2" href="logIn.jsp"><fmt:message key="sign.up"/></a>
            <a class="btn" href="signUp.jsp"><fmt:message key="log.in"/></a>
        </div>
    </div>
</nav>
<header class="bg-dark py-5">
    ...
    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
        <a class="btn btn-primary btn-lg px-4 me-sm-3" href="logIn.jsp"><fmt:message key="get.started"/></a>
    </div>
</header>
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
...
<footer class="py-5 bg-dark">
    <div class="container"><p class="m-0 text-center text-white"><fmt:message key="welcome"/> Welcome </p></div>
</footer>
</body>
</html>
